...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\popupdictionary on
     Windows, /home/user/dev/popupdictionary on Linux) in a file named
     popupdictionary@kentaro.kawamoto and copy that file to
